          ...
          <div>
            ...
            <ul className="space-y-3 text-sm" style={{ color: "var(--texte-secondaire)" }}>
              <li className="flex items-start gap-2">
                ...
                <span>
                  2B rue de la Mare, 27150 MARTAGNY
                  <br />
                  <span className="text-xs">26 Av. V.I. Lénine, 92000 Nanterre (le lundi)</span>
                </span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:0672274589" className="hover:opacity-70 transition-opacity">
                  06 72 27 45 89
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:lexpressiondelame@gmail.com" className="hover:opacity-70 transition-opacity">
            ...
            <div className="mt-4">
              <p className="text-xs" style={{ color: "var(--gris-doux)" }}>
                ...
                Forges les Eaux, Rouen, Beauvais, Nanterre
              </p>
            </div>
          </div>
        </div>
